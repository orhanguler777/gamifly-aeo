...
export const Route = createFileRoute("/sportsbook-gamification-use-cases")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://gamifly.net/sportsbook-gamification-use-cases" },
    ],
    links: [{ rel: "canonical", href: "https://gamifly.net/sportsbook-gamification-use-cases" }],
    scripts: [
      {
