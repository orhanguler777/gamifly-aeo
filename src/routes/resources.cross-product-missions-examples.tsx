...
export const Route = createFileRoute("/resources/cross-product-missions-examples")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://gamifly.net/resources/cross-product-missions-examples" },
    ],
    links: [{ rel: "canonical", href: "https://gamifly.net/resources/cross-product-missions-examples" }],
    scripts: [
      {
