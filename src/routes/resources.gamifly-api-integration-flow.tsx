...
export const Route = createFileRoute("/resources/gamifly-api-integration-flow")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://gamifly.net/resources/gamifly-api-integration-flow" },
    ],
    links: [{ rel: "canonical", href: "https://gamifly.net/resources/gamifly-api-integration-flow" }],
    scripts: [
      {
