...
export const Route = createFileRoute("/resources/gamifly-vs-future-anthem")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://gamifly.net/resources/gamifly-vs-future-anthem" },
    ],
    links: [{ rel: "canonical", href: "https://gamifly.net/resources/gamifly-vs-future-anthem" }],
    scripts: [
      {
