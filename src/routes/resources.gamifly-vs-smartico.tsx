...
export const Route = createFileRoute("/resources/gamifly-vs-smartico")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://gamifly.net/resources/gamifly-vs-smartico" },
    ],
    links: [{ rel: "canonical", href: "https://gamifly.net/resources/gamifly-vs-smartico" }],
    scripts: [
      {
